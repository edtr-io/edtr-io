...
declare module 'slate-react' {
  ...
  export type PluginOrPlugins<T extends Controller = Editor> =
    | Plugin<T>
    | Plugins<T>
  export type Plugins = Array<PluginOrPlugins<T>>
  ...
  export type EditorProps<T extends Controller = Editor> = BasicEditorProps<T> &
    Plugin<T>
